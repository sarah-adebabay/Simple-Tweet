...
I love using Twitter, so it was so awesome to take the time to understand the code that is necessary in building an app, like Twitter. Because I am a newbie to Android development, it was difficult trying to learn Android Studio and build such a complex app, but it was so rewarding. I am even more invigorated to build apps, and this project has gotten me excited about the app that I get to build with my teammates at FBU.
